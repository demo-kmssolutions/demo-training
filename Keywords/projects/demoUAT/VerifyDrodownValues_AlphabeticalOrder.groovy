...
public class VerifyDrodownValues_AlphabeticalOrder {
	...
	@Keyword
	public static void verifyOptionsInDropdownInAphabeticalOrder(TestObject objectto, String defaultOption) {
		...
		for (WebElement option : ele.getOptions()) {
			...
			if(defaultOption.equals(option.getText())) break
