...
WebUI.waitForElementVisible(findTestObject('Test Object/Product Name/gitHub/Pages/Login Page/Page_Sign in to GitHub  GitHub/h1_Sign_in_to_GitHub'), 
    60)

WebUI.verifyTextPresent('Sign in to GitHub', false)

WebUI.sendKeys(findTestObject('Test Object/Product Name/gitHub/Pages/Login Page/Page_Sign in to GitHub  GitHub/input_Username'), 
    username)

WebUI.setText(findTestObject('Test Object/Product Name/gitHub/Pages/Login Page/Page_Sign in to GitHub  GitHub/input_password'), 
    password)
