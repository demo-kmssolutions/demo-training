...
actualHeading = WebUI.getText(findTestObject('Object Repository/Test Object/Product Name/The_Internet/Page_The Internet/h1_heading'))

WebUI.verifyEqual(actualHeading, 'Welcome to the-internet')
